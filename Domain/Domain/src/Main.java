...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Usuario admin = new Admin(null, null);
        Usuario agente = new Agente(null, null);
        Usuario aluno = new Aluno(null, null);
        ...
        usuarios.add(new Agente("Fabio", "fabio123"));
                ...
                case 2 -> {
                    ...
                    if (usuario != null && usuario.autenticar(LoginSenha)) {
                        ...
                        if (usuario instanceof Aluno) {
                            ...
                            AgenteDeCampo.main(new String[0]);
                        }
